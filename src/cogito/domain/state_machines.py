...
def validate_transition_attempt(
    entity_id: str, current: RunAttemptStatus, target: RunAttemptStatus
) -> None:
...
DELIVERY_TRANSITIONS: dict[DeliveryStatus, frozenset[DeliveryStatus]] = {
    ...
    DeliveryStatus.partially_sent: frozenset(
        {DeliveryStatus.retry_scheduled, DeliveryStatus.failed}
    ),
    ...
    DeliveryStatus.unknown: frozenset(
        {DeliveryStatus.retry_scheduled, DeliveryStatus.sent, DeliveryStatus.failed}
    ),
...
def validate_transition_delivery(
    entity_id: str, current: DeliveryStatus, target: DeliveryStatus
) -> None:
