...
class OpenClawWeixinClient:
    ...
    async def login(
        ...
        on_qrcode: typing.Callable[[str, str], typing.Any] | None = None,
        on_status: typing.Callable[[str], typing.Any] | None = None,
    ) -> LoginResult:
...
def _parse_cdn_media(data: dict | None) -> CDNMedia | None:
    if not data:
        return None
    return CDNMedia(
...
def _cdn_media_to_dict(media: CDNMedia | None) -> dict | None:
    if not media:
        return None
    d: dict = {}
