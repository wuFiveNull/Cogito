...
from cogito.channel.clients.wecom_ai_bot_api.api import StreamSession, parse_wecom_bot_message
...
class WecomBotWsClient:
    ...
    async def reply_text(self, req_id: str, content: str) -> dict | None:
    ...
    async def send_message(self, chat_id: str, content: str, msgtype: str = 'markdown') -> dict | None:
    ...
    async def _send_and_wait_ack(self, frame: dict) -> dict | None:
