...
from cogito.channel.clients.wecom_ai_bot_api.api import WecomBotClient
from cogito.channel.clients.wecom_ai_bot_api.wecombotevent import WecomBotEvent
from cogito.channel.clients.wecom_ai_bot_api.ws_client import WecomBotWsClient
...
class WecomBotAdapter(abstract_platform_adapter.AbstractMessagePlatformAdapter):
    bot: WecomBotClient | WecomBotWsClient
    bot_account_id: str
