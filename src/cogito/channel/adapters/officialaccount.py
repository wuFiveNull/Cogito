...
from cogito.channel.clients.official_account_api.api import OAClient, OAClientForLongerResponse
from cogito.channel.clients.official_account_api.oaevent import OAEvent
...
class OfficialAccountAdapter(abstract_platform_adapter.AbstractMessagePlatformAdapter):
    ...
    bot: OAClient | OAClientForLongerResponse = pydantic.Field(exclude=True)
    bot_uuid: str = None
