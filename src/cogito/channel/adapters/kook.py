...
class KookAdapter(abstract_platform_adapter.AbstractMessagePlatformAdapter):
    ...
    ws: websockets.WebSocketClientProtocol | None = pydantic.Field(exclude=True, default=None)
    ws_task: asyncio.Task | None = pydantic.Field(exclude=True, default=None)
    ...
    # HTTP session
    http_session: aiohttp.ClientSession | None = pydantic.Field(exclude=True, default=None)
