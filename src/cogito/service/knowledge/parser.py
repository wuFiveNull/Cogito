            ...
            if buf:
                ...
                if text:
                    ...
                    blocks.append(ParsedBlock(
                        kind="paragraph", text=text, heading_path=path,
                        start_offset=block_start, end_offset=end_offset,
                    ))
                buf.clear()
        ...
        for line in lines:
            ...
            if heading:
                ...
                current_heading_stack = [
                    h for h in current_heading_stack if h[0] < level
                ]
                current_heading_stack.append((level, title))
                blocks.append(ParsedBlock(
                    kind="heading", text=title, heading_path=title,
